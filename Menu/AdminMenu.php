...
namespace Craigh\SimpleScrollTheme\Menu;
...
class AdminMenu
{
    ...
    {
        $menu = $this->factory->createItem('simpleScrollThemeAdminMenu');
        ...
        if ($this->permissionApi->hasPermission('ZikulaZAuthModule::', '::', ACCESS_ADMIN)) {
            $menu->addChild('ZAuth', ['route' => 'zikulazauthmodule_useradministration_list']);
        }
